...
class ComputerVisionActivity : AppCompatActivity(), View.OnClickListener, OptionView.Callback {
    ...
    private inner class Listener : CameraListener() {
        ...
        override fun onPictureTaken(result: PictureResult) {
            ...
            val intent = Intent(this@ComputerVisionActivity, PicturePreviewActivity::class.java)
        ...
        override fun onVideoTaken(result: VideoResult) {
            ...
            val intent = Intent(this@ComputerVisionActivity, VideoPreviewActivity::class.java)
            startActivity(intent)
